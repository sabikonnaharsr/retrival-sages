...
const Blog = () => {
  return (
    <div>
      <section className="dark:bg-gray-800 duration-700 ease-in mt-28 dark:text-gray-100 w-auto">
      ...
      {/* footer start */}
    <div className="mb-6">
  <footer className="px-4 mt-10 divide-y shadow-2xl dark:text-gray-900 font-semibold">
