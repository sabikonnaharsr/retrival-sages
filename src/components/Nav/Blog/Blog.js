...
const Blog = () => {
  return (
    <div>
      <section className="dark:bg-gray-800 mt-28 dark:text-gray-100 w-auto">
      ...
      {/* footer start */}
        <div>
        <div>
    <footer className="px-4 mb-24 divide-y shadow-2xl dark:text-gray-50  dark:bg-gray-800 font-semibold">
	...
	<div className="py-6 text-sm text-center dark:text-gray-50 font-medium">© 2022 All rights reserved, sabikonnahar.sr@gmailcom</div>
</footer>
</div>
        </div>
    </div>
