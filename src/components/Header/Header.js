...
const Header = () => {
  return (
    ...
    <div className="inset-y-0 top-0 right-0 z-0 w-full max-w-xl px-4 mx-auto md:px-0 lg:pr-0 lg:mb-0 lg:mx-0 lg:w-7/12 lg:max-w-full lg:absolute xl:px-0">
      ...
      <img
        className="object-cover w-full rounded shadow-lg lg:rounded-none lg:shadow-none lg:h-full h-80 "
        src={images}
        alt=""
      />
    </div>
    <div className="relative flex flex-col items-start w-full max-w-xl px-4 mx-auto md:px-0 lg:px-8 lg:max-w-screen-xl">
      <div className="mb-16 lg:my-40 lg:max-w-lg lg:pr-5">
        <p className="inline-block px-3 py-px mb-4 text-xxl font-semibold tracking-wider text-teal-900 uppercase rounded-full bg-teal-accent-400">
          Retrival Sages
        </p>
...
{/* footer  */}
    <div>
    <footer className="px-4 divide-y shadow-slate-50 shadow-xl  dark:text-gray-800">
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		...
		<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
			<div className="space-y-3">
				<h3 className="tracking-wide uppercase dark:text-gray-800">Product</h3>
			...
			<div className="space-y-3">
				<h3 className="tracking-wide uppercase dark:text-gray-800">Topics</h3>
				<ul className="space-y-1">
					<li>
			...
			<div className="space-y-3">
				<h3 className="uppercase dark:text-gray-800">Developers</h3>
				<ul className="space-y-1">
					<li>
			...
			<div className="space-y-3">
				<div className="uppercase dark:text-gray-800">Social media</div>
